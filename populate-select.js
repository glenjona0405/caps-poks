...
try {
    const res = await fetch('https://caps-poks-production.up.railway.app:5000/players');
...
try {
    const res = await fetch('https://caps-poks-production.up.railway.app:5000/trx/allTrxGames');
